...
export default function Diente4({
    diente,
    hanleFunction,
    hanleFunctionText,
    selectExtra,
    ...
    return (
        <>
            ...
            }} sx={{ display: "flex", flexDirection: "column", transform: 'scaleY(-1)' }}>
                <Box sx={{ transform: "scale(1)", marginLeft: "0px", display: "flex", flexDirection: "column" }} >
                    <Box sx={{ marginBottom: "0" }}>
                        ...
                        <svg width="60" height="70">
                            ...
                            {/* centerTopLeft */}
                            <g onClick={() => hanleFunction(diente.id, diente.option, 'centerTopLeft', selectExtra !== null && selectExtra !== undefined && selectExtra)} style={{ cursor: 'pointer' }}>
                                <polygon
                                    points="10,40 10,50 30,50 30,40"
                                    fill={
                                        diente.carie.centerTopLeft === true ? "red" :
                                            diente.restauracion.centerTopLeft === true ? "blue" :
                                                "white"
                                    }
                                    stroke={
                                        diente.restauracionTemporal.centerTopLeft === true ? "red" :
                                            diente.sellantes.centerTopLeft === true ? "blue" :
                                                'black'
                                    }
                                    stroke-width={
                                        diente.restauracionTemporal.centerTopLeft === true ? "5" :
                                            diente.sellantes.centerTopLeft === true ? "5" :
                                                '1'
                                    }
                                />
                            </g>
                            {/* centerBottomLeft */}
                            <g onClick={() => hanleFunction(diente.id, diente.option, 'centerBottomLeft', selectExtra !== null && selectExtra !== undefined && selectExtra)} style={{ cursor: 'pointer' }}>
                                <polygon
                                    points="10,50 10,60 30,60 30,50"
                                    fill={
                                        diente.carie.centerBottomLeft === true ? "red" :
                                            diente.restauracion.centerBottomLeft === true ? "blue" :
                                                "white"
                                    }
                                    stroke={
                                        diente.restauracionTemporal.centerBottomLeft === true ? "red" :
                                            diente.sellantes.centerBottomLeft === true ? "blue" :
                                                'black'
                                    }
                                    stroke-width={
                                        diente.restauracionTemporal.centerBottomLeft === true ? "5" :
                                            diente.sellantes.centerBottomLeft === true ? "5" :
                                                '1'
                                    }
                                />
                            </g>
                            {/* centerTopRight */}
                            <g onClick={() => hanleFunction(diente.id, diente.option, 'centerTopRight', selectExtra !== null && selectExtra !== undefined && selectExtra)} style={{ cursor: 'pointer' }}>
                                <polygon
                                    points="30,40 30,50 50,50 50,40"
                                    fill={
                                        diente.carie.centerTopRight === true ? "red" :
                                            diente.restauracion.centerTopRight === true ? "blue" :
                                                "white"
                                    }
                                    stroke={
                                        diente.restauracionTemporal.centerTopRight === true ? "red" :
                                            diente.sellantes.centerTopRight === true ? "blue" :
                                                'black'
                                    }
                                    stroke-width={
                                        diente.restauracionTemporal.centerTopRight === true ? "5" :
                                            diente.sellantes.centerTopRight === true ? "5" :
                                                '1'
                                    }
                                />
                            </g>
                            {/* centerBottomRight */}
                            <g onClick={() => hanleFunction(diente.id, diente.option, 'centerBottomRight', selectExtra !== null && selectExtra !== undefined && selectExtra)} style={{ cursor: 'pointer' }}>
                                <polygon
                                    points="30,50 30,60 50,60 50,50"
                                    fill={
                                        diente.carie.centerBottomRight === true ? "red" :
                                            diente.restauracion.centerBottomRight === true ? "blue" :
                                                "white"
                                    }
                                    stroke={
                                        diente.restauracionTemporal.centerBottomRight === true ? "red" :
                                            diente.sellantes.centerBottomRight === true ? "blue" :
                                                'black'
                                    }
                                    stroke-width={
                                        diente.restauracionTemporal.centerBottomRight === true ? "5" :
                                            diente.sellantes.centerBottomRight === true ? "5" :
                                                '1'
                                    }
                                />
                            </g>
            ...
            <Box sx={{ border: "1px solid transparent", borderRadius: "2px", margin: "0px", padding: "2px", marginTop: "0px", display: "flex", justifyContent: "center", justifyItems: "center", alignContent: "center", alignItems: "center" }}>{diente.label}</Box>

            <Box onClick={() => hanleFunction(diente.id, diente.option, 'box2', selectExtra !== null && selectExtra !== undefined && selectExtra)} sx={{ border: "1px solid black", borderRadius: "2px", margin: "0px", padding: "2px", color: diente.box2 !== '20' ? 'black' : "transparent", display: "flex", justifyContent: "center", justifyItems: "center", alignContent: "center", alignItems: "center", marginTop: "40px" }}>{diente.box2}</Box>
